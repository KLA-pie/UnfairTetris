(function e(t, n, r) { function s(o, u) { if (!n[o]) { if (!t[o]) { var a = typeof require == "function" && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); var f = new Error("Cannot find module '" + o + "'"); throw f.code = "MODULE_NOT_FOUND", f } var l = n[o] = { exports: {} }; t[o][0].call(l.exports, function (e) { var n = t[o][1][e]; return s(n ? n : e) }, l, l.exports, e, t, n, r) } return n[o].exports } var i = typeof require == "function" && require; for (var o = 0; o < r.length; o++)s(r[o]); return s })({
	1: [function (require, module, exports) {
		...
		*/
		...
		//colors for shapes
		var colors = ['#0057b7', '#ffdd00'];

		//colors for chocolate elements
		var chocolate_colors = ['#513b1c', '#490206', '#ede6d6'];

		//list of songs to play
		var songList = ['Level1.mp3', 'Level2.mp3', 'Level3.mp3'];

		//set of dialogue to use in the first level
		var level_1 = ['Images/Level1_0.png', 'Images/Level1_1.png', 'Images/Level1_2.png', 'Images/Level1_3.png', 'Images/Level1_4.png', 'Images/Level1_5.png', 'Images/Level1_6.png', 'Images/Level1_7.png', 'Images/Level1_8.png', 'Images/Level1_9.png'];

		//set of dialogue for clearing blocks in the first level
		var clear_1 = ['Images/Clear1_0.png', 'Images/Clear1_1.png', 'Images/Clear1_2.png', 'Images/Clear1_3.png', 'Images/Clear1_4.png'];

		//set of dialogue to use in the second level
		var level_2 = ['Images/Level2_0.png', 'Images/Level2_1.png', 'Images/Level2_2.png', 'Images/Level2_3.png', 'Images/Level2_4.png', 'Images/Level2_5.png', 'Images/Level2_6.png', 'Images/Level2_7.png', 'Images/Level2_8.png', 'Images/Level2_9.png'];

		//set of dialogue for clearing blocks in the second level
		var clear_2 = ['Images/Clear2_0.png', 'Images/Clear2_1.png', 'Images/Clear2_2.png', 'Images/Clear2_3.png', 'Images/Clear2_4.png'];

		//set of dialogue to use in the third level
		var level_3 = ['Images/Level3_0.png', 'Images/Level3_1.png', 'Images/Level3_2.png', 'Images/Level3_3.png', 'Images/Level3_4.png', 'Images/Level3_5.png', 'Images/Level3_6.png', 'Images/Level3_7.png', 'Images/Level3_8.png', 'Images/Level3_9.png'];

		//set of dialogue for clearing blocks in the third level
		var clear_3 = ['Images/Clear3_0.png', 'Images/Clear3_1.png', 'Images/Clear3_2.png', 'Images/Clear3_3.png', 'Images/Clear3_4.png'];

		//set cutscene between first and second level
		var scene_1 = ['Images/Scene1_0.png', 'Images/Scene1_1.png', 'Images/Scene1_2.png', 'Images/Scene1_3.png', 'Images/Scene1_4.png', 'Images/Scene1_5.png', 'Images/Scene1_6.png'];

		//set cutscene between second and third level
		var scene_2 = ['Images/Scene2_0.png', 'Images/Scene2_1.png', 'Images/Scene2_2.png', 'Images/Scene2_3.png', 'Images/Scene2_4.png', 'Images/Scene2_5.png', 'Images/Scene2_6.png'];

		//set final cutscene
		var scene_3 = ['Images/Scene3_0.png', 'Images/Scene3_1.png', 'Images/Scene3_2.png', 'Images/Scene3_3.png', 'Images/Scene3_4.png', 'Images/Scene3_5.png', 'Images/Scene3_6.png'];

		//set of dialogue for chocolate placement
		var chocolate = ['Images/Chocolate0.png', 'Images/Chocolate1.png', 'Images/Chocolate2.png', 'Images/Chocolate3.png', 'Images/Chocolate4.png', 'Images/Chocolate5.png', 'Images/Chocolate6.png'];
		...
		var sceneBgStart = '#008000';

		//scene gradient end color
		var sceneBgEnd = '#1b4c1d';
		...
		exports.CHOCOLATE_COLORS = chocolate_colors;

		exports.LEVEL_1 = level_1;

		exports.CLEAR_1 = clear_1;

		exports.SCENE_1 = scene_1;

		exports.LEVEL_2 = level_2;

		exports.CLEAR_2 = clear_2;

		exports.SCENE_2 = scene_2;

		exports.LEVEL_3 = level_3;

		exports.CLEAR_3 = clear_3;

		exports.SCENE_3 = scene_3;

		exports.CHOCOLATE = chocolate;

		exports.SONG_LIST = songList
		...
		*/
		...
		Tetris.prototype = {
			...
			init: function (options) {
				...
				this.level_pic = consts.LEVEL_1;
				this.clear_row = consts.CLEAR_1;
				this.chocolate_chance = consts.CHOCOLATE;
				this.cutscene = consts.SCENE_1;
			...
			// Place a chocolate block
			_PlaceChocolate: function () {
				this.chocolate_position = Math.floor(Math.random() * 190) + 10;
				this.chocolate_row = Math.floor(this.chocolate_position / 10);
				this.chocolate_column = this.chocolate_position % 10;
				this.chocolate_type = Math.floor(Math.random() * 3);
				this.chocolate_color = consts.CHOCOLATE_COLORS[this.chocolate_type];
				this.matrix[this.chocolate_row][this.chocolate_column] = this.chocolate_color
				this._draw();
			...
			_check: function () {
				...
				if (this.chocolate_block % n == 0) {
					...
					image.src = consts.CHOCOLATE[image_select];
				}
				else if (rows.length) {
					image_select = Math.floor(Math.random() * 5)
					image.src = this.clear_row[image_select]
				}
				else {
					image_select = Math.floor(Math.random() * 10);
					image.src = this.level_pic[image_select];
				};
				if (rows.length) {
					...
					switch (this.level) {
						case 1: {
							if (this.score >= 100) {
								...
								clearMatrix(this.matrix);
								this.level = 2;
								views.setSong[this.level]
								this.interval = 400;
								this.score = 0;
								this.level_pic = consts.LEVEL_2;
								this.clear_row = consts.CLEAR_2;
								views.setScore(0);
								views.setLevel(this.level)
								image.src = consts.SCENE_1[0];
								setTimeout(function () {
									image.src = consts.SCENE_1[1];
								}, 5000);
								setTimeout(function () {
									image.src = consts.SCENE_1[2];
								}, 10000);
								setTimeout(function () {
									image.src = consts.SCENE_1[3];
								}, 15000);
								setTimeout(function () {
									image.src = consts.SCENE_1[4];
								}, 20000);
								setTimeout(function () {
									image.src = consts.SCENE_1[5];
								}, 25000);
								setTimeout(function () {
						...
						case 2: {
							if (this.score >= 2000) {
								...
								this.score = 0;
								this.chocolate = 1;
								this.level_pic = consts.LEVEL_3;
								this.clear_row = consts.CLEAR_3;
								views.setScore(0);
								views.setLevel(this.level);
								image.src = consts.SCENE_2[0];
								setTimeout(function () {
									image.src = consts.SCENE_2[1];
								}, 5000);
								setTimeout(function () {
									image.src = 'Images/Scene2_2.png';
								}, 10000);
								setTimeout(function () {
									image.src = consts.SCENE_2[3];
								}, 15000);
								setTimeout(function () {
									image.src = consts.SCENE_2[4];
								}, 20000);
								setTimeout(function () {
									image.src = consts.SCENE_2[5];
								}, 25000);
								setTimeout(function () {
									image.src = consts.SCENE_2[6];
								}, 30000);
							}
						}
						case 3: {
							if (this.score >= 3000) {
								this.pause()
								image.src = consts.SCENE_3[0];
								setTimeout(function () {
									image.src = consts.SCENE_3[1];
								}, 5000);
								setTimeout(function () {
									image.src = consts.SCENE_3[2];
								}, 10000);
								setTimeout(function () {
									image.src = consts.SCENE_3[3];
								}, 15000);
								setTimeout(function () {
									image.src = consts.SCENE_3[4];
								}, 20000);
								setTimeout(function () {
									image.src = consts.SCENE_3[5];
								}, 25000);
								setTimeout(function () {
		...
		*/
		var tetrisView = {
			...
			// Update the song
			setSong: function (levelNumber) {
				songChoice.innerHTML = consts.SONG_LIST[levelNumber - 1];
			},
			// Update the level
